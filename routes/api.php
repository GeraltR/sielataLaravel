...
Route::middleware(['auth:sanctum'])->get('/printmodels/byuser/{user_id}', [RegisteredModelsController::class, 'print_models_by_user']);
Route::middleware(['auth:sanctum'])->get('/printmodels/filter/classfilter/{idclass}/age/{age}', [RegisteredModelsController::class, 'print_models_by_filter']);
